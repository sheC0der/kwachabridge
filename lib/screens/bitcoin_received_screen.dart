...
class BitcoinReceivedScreen extends StatelessWidget {
  const BitcoinReceivedScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Your Lightning payment settled.', style: TextStyle(color: kMuted, fontSize: 16)),
              ...
              Container(
                ...
                child: Column(
                  children: const [
                    _Row('Amount received', '${MockData.swapSatsAmount} sats'),
                    SizedBox(height: 14),
                    _Row('You paid', 'MK 5,000'),
                    SizedBox(height: 14),
              ...
              TextButton(
                ...
                child: const Text('Back to Home', style: TextStyle(color: kMuted)),
              ),
