...
class _CustomerProfileSetupScreenState extends State<CustomerProfileSetupScreen> {
  ...
  void initState() {
    super.initState();
    _displayNameController.text = MockData.customerName;
    _phoneController.text = '881 234 567';
  }
  ...
  Future<void> _saveProfile(String publicKey) async {
    ...
    final displayName = name.isEmpty ? MockData.customerName : name;
    ...
    try {
      ...
      if (mounted) Navigator.pushReplacementNamed(context, '/customer-discovery');
    } catch (e) {
      if (mounted) {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Help agents verify your identity for secure swaps.', style: TextStyle(color: kMuted, fontSize: 14)),
